...
import com.mh.dto.servicios.sync.push.SalidaTiendaPushDTO;
...
@Service
public class VentasPushService extends PushService<SalidaTiendaPushDTO, SalidaTiendaMessage, SalidaTienda> {
